# see http://www.evolve.st/articles/11-testing-named-scope-with-rspec
# and
# http://gist.github.com/11918
#
#  CompanyProduct.should have_named_scope(:for_sales_channels, lambda {|channels| {:conditions => ["prices.sales_channel_id IN (?)", channels], :include => :prices}})
